...
public class Person extends AppCompatActivity {
    ...
    RelativeLayout rlDonHangHT, rlDonHangDaGiao, rlDonHangHuy,rlDonHangTraLai;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_DangLayHang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                finish();
                Intent intent=new Intent(getApplicationContext(),DonHang.class);
                intent.putExtra("url","https://nam1612it.bsite.net/selectDetailOrderDangGiao/"+String.valueOf(userLogin.cusID)+ "," + String.valueOf(userLogin.cusID)+","+"Đang lấy hàng");
                startActivity(intent);
            }
        });
        ...
        rlDonHangHT.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                Intent intent=new Intent(getApplicationContext(),DonHang.class);
                intent.putExtra("url","https://nam1612it.bsite.net/selectDetailOrderHoanThanh/"+String.valueOf(userLogin.cusID)+ "," + String.valueOf(userLogin.cusID)+","+"Giao hàng thành công");
                startActivity(intent);
            }
        });
        rlDonHangDaGiao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                Intent intent=new Intent(getApplicationContext(),DonHang.class);
                intent.putExtra("url","https://nam1612it.bsite.net/selectDetailOrderDaGiao/"+String.valueOf(userLogin.cusID)+ "," + String.valueOf(userLogin.cusID)+","+"Đã giao hàng");
                startActivity(intent);
            }
        });
        rlDonHangHuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                Intent intent=new Intent(getApplicationContext(),DonHang.class);
                intent.putExtra("url","https://nam1612it.bsite.net/selectDetailOrderDaHuy/"+String.valueOf(userLogin.cusID)+ "," + String.valueOf(userLogin.cusID)+","+"Đã hủy");
                startActivity(intent);
            }
        });
        rlDonHangTraLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
                Intent intent=new Intent(getApplicationContext(),DonHang.class);
                intent.putExtra("url","https://nam1612it.bsite.net/selectDetailOrderTraLai/"+String.valueOf(userLogin.cusID)+ "," + String.valueOf(userLogin.cusID)+","+"Trả hàng");
                startActivity(intent);
            }
        });
...
//        });
    ...
    public void init()
    {
        ...
        rlDonHangHT = this.findViewById(R.id.rlDonhangThanhCong);
        rlDonHangDaGiao = this.findViewById(R.id.rlDonhangDaGiao);
        rlDonHangHuy = this.findViewById(R.id.rlDonhangHuy);
        rlDonHangTraLai = this.findViewById(R.id.rlDonhangTraLai);
    }
    @Override
