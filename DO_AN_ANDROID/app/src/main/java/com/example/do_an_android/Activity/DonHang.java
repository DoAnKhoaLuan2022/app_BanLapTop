        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        a.setAdapter(new DonHangAdapter(com.example.do_an_android.Activity.DonHang.this,DonHang.this,list,idUser,trangThai));
                        ...
                        tv_TongTien.setText("Tổng tiền: "+String.valueOf(formatter.format(tong))+" VND");
                    }
                });
            }
        });
